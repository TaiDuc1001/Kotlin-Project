...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                textAction.text = getResources().getString(R.string.lemon_state_string, "select a lemon.")
                lemonImage!!.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                textAction.text = getResources().getString(R.string.lemon_state_string, "juice the lemon.")
                lemonImage!!.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                textAction.text = getResources().getString(R.string.lemon_state_string, "drink your lemonade.")
                lemonImage!!.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                textAction.text = getResources().getString(R.string.lemon_state_string, "start again.")
